...
{
    // Here, we take in AR marker coordinates and hyperlink coordinates (both are PyMuPDF-based coordinates),
    // and calculate the world-space offset (with respect to the AR marker) that the
    // augmented reality hyperlink overlay should have.
    ...
    // Here, we take in AR marker coordinates and hyperlink coordinates (both are PyMuPDF-based coordinates),
    // and calculate the world-space scale that the augmented reality hyperlink overlay should have.
